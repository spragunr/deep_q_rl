...
def main(args):
    ...
    p3 = subprocess.Popen(['./rl_glue_ale_experiment.py', '--epoch_length', str(parameters.steps_per_epoch), 
        '--test_length', str(parameters.test_steps), '--num_epochs', str(parameters.epochs)], env=my_env, close_fds=close_fds)
